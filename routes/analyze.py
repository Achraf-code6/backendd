...
IMPORTANT : TON EXPLICATION DOIT ÊTRE BASÉE SUR DES CHIFFRES CONCRETS (Preuves sociales).
- Cite le nombre de reviews, la note et les ventes si disponibles.
- Si les données sont manquantes, explique pourquoi le produit semble quand même avoir du potentiel (ou non) en te basant sur la catégorie et le titre.
- Ton client a besoin de PREUVES pour son étude de marché.

Critères de scoring (25 points chacun) :
1. Popularité/Tendance - Potentiel de recherche.
2. Récence - Cycle de vie du produit.
3. Preuve sociale (CRITIQUE) - Utilise les reviews, notes et ventes.
4. Potentiel de vente - Attractivité globale.

Réponds STRICTEMENT au format JSON suivant (sans markdown, sans code block) :
{
  "score": [0-100],
  "explanation": "Expertise détaillée incluant les CHIFFRES clés trouvés (ex: '4.8/5 avec 350 reviews et 1000+ ventes'). Sois factuel.",
  "breakdown": {
    "popularity": [0-25],
    "recency": [0-25],
    "reviews": [0-25],
